...
function filterStarsConstellations() {
  ...
  stars.forEach((star) => {
    const starConstellations = star
      .getAttribute("data-constellation-id")
      .split(",");

    if (
      selectedConstellations.some((constellationId) =>
        starConstellations.includes(constellationId)
      )
    ) {
...
if (savedOpacity !== null) {
  ...
  buttons.forEach((button) => {
    if (
      ...
      "fog-" + opacityValues.indexOf(savedOpacity)
    ) {
      button.classList.add("active");
      activeButton = button;
    }
              ...
              <div class="details__frame">
                <div class="image__section">
                  <img class="details__image" src="${
                    constellationDetails.image
                  }" />
                </div>
                <div class="text__section">
                  <h2 class="details__header">${constellationDetails.name}</h2>
                  <ul>
                  ${constellationDetails.stars
                    .map((star) => `<li>${star.name}</li>`)
                    .join("")}
                </ul>
                  <div class="text__main">
                    ...
                    <th>Gwiazdy przypisane do konstelacji:</th><br>
                  </div>
                  <div class="text__main">
                  <div class="text__field">
                  </div>
                  ...
                  <div class="button__section">
                    <a href="/editConstellation/${
                      constellationDetails._id
                    }" class="default__button"><i class="fas fa-edit fa-lg mx-1"></i>Edytuj</a>
                    <a href="/deleteConstellation/${
                      constellationDetails._id
                    }" class="default__button"><i class="fas fa-trash fa-lg mx-1"></i>Usuń</a>
                    <button class="default__button back-button"><i class="fas fa-chevron-left"></i> Powrót</button>
                  </div>
                </div>
              </div>
